...
class MiddleburyStereoDataset(BaseDataset):
    ...
    def load_images(self, idx, do_flip=False):
        ...
        image = self.loader(os.path.join(self.data_path, 'MiddEval3/trainingF',
                                         folder, 'im0.png'))
        stereo_image = self.loader(os.path.join(self.data_path, 'MiddEval3/trainingF',
                                                folder, 'im1.png'))
